...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("angular-ui-scheduler/src/angularUiScheduler.html",
    ...
    "                            <span>:</span><input name=\"schedulerStartMinute\" id=\"schedulerStartMinute\" type=\"number\"  class=\"scheduler-time-spinner\" ng-model=\"schedulerStartMinute\" placeholder=\"MM\" min=\"0\" max=\"59\" required ng-change=\"scheduleTimeChange()\" >\n" +
    "                            <span>:</span><input name=\"schedulerStartSecond\" id=\"schedulerStartSecond\" type=\"number\"  class=\"scheduler-time-spinner\" ng-model=\"schedulerStartSecond\" placeholder=\"SS\" min=\"0\" max=\"59\"  required ng-change=\"scheduleTimeChange()\" >\n" +
    "                        </div>\n" +
